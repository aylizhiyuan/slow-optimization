 ...
 * @LastEditTime: 2020-04-19 19:59:21
...
用户 ping 自己 127.0.0.1 --> 看自己本地的TCP协议是否有问题

ping ----> 内网地址 检查本地的IP地址设置是否有误

ping ----> 网关 查看自己和路由器之间的连接是否存在问题

假设出现比较慢的情况,我们就需要用到tranceroute来查看到底是在哪个环节慢了..
...
因为浏览器的TTFB的时间 = 达到服务器的时间 + 服务器处理的时间 + 服务器返回的时间
